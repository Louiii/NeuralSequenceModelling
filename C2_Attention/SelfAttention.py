...
class MaskedSelfAttention(nn.Module):
    '''
    Masks the input to the right of current time step
    If end_prj is True, forward passes the output through a linear layer at the end
    '''
    def __init__(self, emb_dim, score_fn='dotScaled', bias=True, end_prj=True, atn_drop=0.1, res_drop=0.1):
        super().__init__()
        ...
        self.resd_drop = nn.Dropout(res_drop)
